...
Function shall correctly upload data with DYNAMIC_DRAW hint and allow updating buffer contents.

Covered requirements:
	- GS-GL20SC-BO-BD-005
*/

static const char* test_case = "GS_GL20SC_BO_BD_TC_005";
static const char* test_procedure = "GS_GL20SC_BO_BD_TP_009";
...
{
#ifdef __x86_64__
	#include "shaders/le/GS_GL20SC_BO_BD_TP_009.dat"
#else
	#include "shaders/be/GS_GL20SC_BO_BD_TP_009.dat"
#endif
};
...
/* Initialization */
void GS_GL20SC_BO_BD_TP_009_init(void) {
    ...
    // Covered requirement 005
    if (usage != GL_DYNAMIC_DRAW) {
        TEST_LOG_FAIL(test_case, test_procedure, "buffer usage expected GL_DYNAMIC_DRAW, got: 0x%x", usage);
...
void GS_GL20SC_BO_BD_TP_009_draw(void) {
...
/* Cleanup */
void GS_GL20SC_BO_BD_TP_009_close(void) {
#ifdef __ubuntu__
