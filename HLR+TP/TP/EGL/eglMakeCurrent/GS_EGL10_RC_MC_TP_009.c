 ...
 * Covered requirement: GS-EGL10-RC-MC-009
 */
static const char* test_case = "GS_EGL10_RC_MC_TC_009";
static const char* test_procedure = "GS_EGL10_RC_MC_TP_009";
...
void GS_EGL10_RC_MC_TP_009_init(void)
{
#ifdef GS_EGL_USE_PTHREAD
    pthread_t thread;
    EGLBoolean result;
...
void GS_EGL10_RC_MC_TP_009_draw(void) { }

void GS_EGL10_RC_MC_TP_009_close(void)
{
#ifdef GS_EGL_USE_PTHREAD
