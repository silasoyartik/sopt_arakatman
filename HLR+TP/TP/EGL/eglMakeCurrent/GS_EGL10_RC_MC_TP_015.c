 ...
 * Covered requirement: GS-EGL10-RC-MC-015
 *
 * Define GS_EGL_PLATFORM_TEST_HOOKS when the target fixture can create the
 * required ancillary-buffer allocation failure condition.
 */
static const char* test_case = "GS_EGL10_RC_MC_TC_015";
static const char* test_procedure = "GS_EGL10_RC_MC_TP_015";
...
void GS_EGL10_RC_MC_TP_015_init(void)
{
#ifdef GS_EGL_PLATFORM_TEST_HOOKS
    EGLDisplay display;
    EGLSurface draw;
    ...
    if (!GS_EGL10_prepare_make_current_error(EGL_BAD_ALLOC,
            &display, &draw, &read, &context))
    {
        TEST_LOG_FAIL(test_case, test_procedure,
            "Platform setup for ancillary-buffer allocation failure failed");
...
void GS_EGL10_RC_MC_TP_015_draw(void) { }

void GS_EGL10_RC_MC_TP_015_close(void)
{
#ifdef GS_EGL_PLATFORM_TEST_HOOKS
