 ...
 * Covered requirement: GS-EGL10-RC-MC-006
 */
static const char* test_case = "GS_EGL10_RC_MC_TC_006";
static const char* test_procedure = "GS_EGL10_RC_MC_TP_006";
static EGLBoolean test_success = EGL_TRUE;
static GS_EGL10_TestEnvironment environment = GS_EGL10_ENV_INITIALIZER;

void GS_EGL10_RC_MC_TP_006_init(void)
{
    EGLBoolean result;
    EGLint error;
    ...
    // Test starts here: use EGL_NO_SURFACE with a valid context.
    (void)eglGetError();
...
void GS_EGL10_RC_MC_TP_006_draw(void) { }
void GS_EGL10_RC_MC_TP_006_close(void)
{
