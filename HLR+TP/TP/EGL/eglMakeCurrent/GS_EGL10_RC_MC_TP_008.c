 ...
 * Covered requirement: GS-EGL10-RC-MC-008
 */
static const char* test_case = "GS_EGL10_RC_MC_TC_008";
static const char* test_procedure = "GS_EGL10_RC_MC_TP_008";
...
void GS_EGL10_RC_MC_TP_008_init(void)
{
#ifdef GS_EGL_USE_PTHREAD
    pthread_t thread;
    EGLBoolean result;
    ...
    {
        // Test starts here: attempt to bind a context current to another thread.
        (void)eglGetError();
        result = eglMakeCurrent(environment.display, second_surface,
            second_surface, environment.context);
        error = eglGetError();
...
void GS_EGL10_RC_MC_TP_008_draw(void) { }

void GS_EGL10_RC_MC_TP_008_close(void)
{
#ifdef GS_EGL_USE_PTHREAD
