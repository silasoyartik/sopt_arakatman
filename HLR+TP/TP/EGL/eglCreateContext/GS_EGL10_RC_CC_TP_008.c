...
static const char* test_case = "GS_EGL10_RC_CC_TC_008";
static const char* test_procedure = "GS_EGL10_RC_CC_TP_008";
...
void GS_EGL10_RC_CC_TP_008_init(void)
{
    EGLConfig config;
    GLuint texture = 0;
    GLenum gl_error;
    ...
    /* CC-008: the texture created above shall be visible in shared_context. */
    if (eglMakeCurrent(framework_display, framework_draw_surface,
...
void GS_EGL10_RC_CC_TP_008_draw(void)
{
}

/* Restores the framework binding and destroys the test-owned contexts. */
void GS_EGL10_RC_CC_TP_008_close(void)
{
