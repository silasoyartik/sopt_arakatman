 ...
 * Covered requirement: GS-EGL10-CM-GCA-022
 */
static const char* test_case = "GS_EGL10_CM_GCA_TC_022";
static const char* test_procedure = "GS_EGL10_CM_GCA_TP_022";
static EGLBoolean test_success = EGL_TRUE;
static GS_EGL10_TestEnvironment environment = GS_EGL10_ENV_INITIALIZER;

void GS_EGL10_CM_GCA_TP_022_init(void)
{
    ...
    // Test starts here: query EGL_TRANSPARENT_RED_VALUE.
    (void)eglGetError();
    ...
    {
        TEST_LOG_FAIL(test_case, test_procedure,
            "EGL_TRANSPARENT_RED_VALUE query returned %u/0x%x with value %d",
...
void GS_EGL10_CM_GCA_TP_022_draw(void) { }

void GS_EGL10_CM_GCA_TP_022_close(void)
{
